...
const killIfOtherHasMore = 'killIfOtherHasMore';
const transformToSingleton = 'transformToSingleton';
const spawnBehind = 'spawnBehind';
const spawnIfHasMore = 'spawnIfHasMore';
...
const subtractHealthPoints = 'subtractHealthPoints';
const increaseSpeedToAll = 'increaseSpeedToAll';
const decreaseSpeedToAll = 'decreaseSpeedToAll';
const setSpeedForAll = 'setSpeedForAll';
const stepBack = 'stepBack';
const undoAll = 'undoAll';
const flipDirection = 'flipDirection';
const reverseDirection = 'reverseDirection';
const attractGaze = 'attractGaze';
const align = 'align';
const turnAround = 'turnAround';
const wrapAround = 'wrapAround';
const teleportToExit = 'teleportToExit';
const pullWithIt = 'pullWithIt';
const bounceForward = 'bounceForward';
